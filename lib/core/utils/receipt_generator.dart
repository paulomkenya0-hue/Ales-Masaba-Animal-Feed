              ...
              children: [
                pw.Center(
                  child: pw.Column(
                    children: [
                      if (logo != null) ...[
                        pw.Image(logo, height: 56, width: 56),
                ...
                if (sale.paymentMethod == 'Mkopo') ...[
                  ...
                  pw.Container(
                    ...
                    child: pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('DENI LILILOBAKI', style: pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold)),
                        pw.Text(_currencyFmt.format(sale.totalAmount), style: pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold)),
                      ],
                    ),
                  ),
                ],
