...
void main() {
  runZonedGuarded(() async {
    ...
    // Firebase (Auth + Firestore). Ikiwa haipo mtandao wakati wa kuanza,
    // Firestore itaendelea kufanya kazi kwa kutumia cache ya ndani baada ya
    // muunganisho wa kwanza kufanikiwa angalau mara moja.
    try {
      await FirebaseService.initialize();
    } catch (e) {
      debugPrint('Firebase init error (itaendelea Offline): $e');
    }
